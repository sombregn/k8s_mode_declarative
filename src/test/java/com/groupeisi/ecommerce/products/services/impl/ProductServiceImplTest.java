...
class ProductServiceImplTest {
    ...
    private ProductDtoRequest getProductDtoRequest(){
        ...
        productDtoRequest.setRef("LAPTOP01");
        productDtoRequest.setName("Laptop");
        productDtoRequest.setStock(200.0);
    ...
    private ProductEntity getProductEntity(){
        ...
        productEntity.setRef("LAPTOP01");
        productEntity.setName("Laptop");
        productEntity.setStock(200.0);
    ...
    private ProductDtoResponse getProductDtoResponse(){
        ...
        productDtoResponse.setRef("LAPTOP01");
        productDtoResponse.setName("Laptop");
        productDtoResponse.setStock(200.0);
    ...
    void saveProductKO() {
        ...
        when(messageSource.getMessage(eq("product.exists"), any(), any(Locale.class))).thenReturn("the product with ref = LAPTOP01 is already created");
        ...
        assertEquals("the product with ref = LAPTOP01 is already created", exception.getMessage());
    ...
    void getProductByRefOK() {
        ...
        Optional<ProductDtoResponse> product = productService.getProductByRef("LAPTOP01");
        assertTrue(product.isPresent());
        assertEquals("LAPTOP01", product.get().getRef());
    }
    ...
    void getProductByRefKO() {
        ...
        EntityNotFoundException exception = assertThrows(EntityNotFoundException.class, () -> productService.getProductByRef("LAPTOP01"));
    ...
    void updateProductOK() {
        ...
        assertEquals("LAPTOP01", updatedProduct.get().getRef());
    }
    ...
    void deleteProductKO() {
        ...
        EntityNotFoundException exception = assertThrows(EntityNotFoundException.class, () -> productService.deleteProduct("LAPTOP01"));
        assertEquals("Product not found", exception.getMessage());
    }
}